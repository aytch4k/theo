...
var (
	...
	command  = flag.String("cmd", "help", "Command to execute (init, commit, merge, status, export)")
...
func showHelp() {
	fmt.Println("DevHub-Git - A blockchain-based Git system")
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  devhub-git [flags] [command]")
	fmt.Println()
